...
Original file is located at
    https://colab.research.google.com/drive/1xmbFZuLdgH8o0Ee2anZDKVFPsaUL99tV
"""
...
data = {
    "w1": modelLinear.input_to_hidden.weight.detach().numpy()[0],
    "w2": modelLinear.input_to_hidden.weight.detach().numpy()[1],
...
# Se pueden poner los resultados en un objeto de Embedding de pytorch pero se le tienen que dar transpuestos
